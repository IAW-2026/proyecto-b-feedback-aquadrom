...
//Este endpoint es para que la app de analytics pueda obtener los mejores vendedores de la base de datos.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('Error en analytics/vendors/top:', error);
    return NextResponse.json({ success: false, error: 'Error al obtener mejores vendedores' }, { status: 500 });
  }
}
