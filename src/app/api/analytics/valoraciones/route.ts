...
//Este endpoint es para que la app de analytics pueda obtener las valoraciones de la base de datos.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('Error en analytics/valoraciones:', error);
    return NextResponse.json({ success: false, error: 'Error al obtener valoraciones' }, { status: 500 });
  }
}
